...
\texttt{CALL_FUNCTION_EX} instruction, with some description of list-building instructions
towards the end, rather than describing every single instruction that is emitted.
...
what terminology will be useful if they are reading language documentation or performing
an internet search.
